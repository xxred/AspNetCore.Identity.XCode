...
namespace Extensions.Identity.Stores.XCode
{
    ...
    public class IdentityRoleClaim : IdentityRoleClaim<IdentityRoleClaim> { }

    /// <summary>IdentityRoleClaim(角色声明集合)</summary>
    public partial class IdentityRoleClaim<TEntity> : Entity<TEntity> where TEntity : IdentityRoleClaim<TEntity>, new()
    {
        #region 对象操作
        static IdentityRoleClaim()
        {
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化TEntity[IdentityRoleClaim]数据……");
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化TEntity[IdentityRoleClaim]数据！");
        //}
