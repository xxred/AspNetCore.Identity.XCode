...
namespace Extensions.Identity.Stores.XCode
{
    ...
    public class IdentityRole : IdentityRole<IdentityRole> { }

    /// <summary>IdentityRole(角色)</summary>
    public partial class IdentityRole<TEntity> : Entity<TEntity> where TEntity : IdentityRole<TEntity>, new()
    {
        #region 对象操作
        static IdentityRole()
        {
        ...
        public override void Valid(Boolean isNew)
        {
            ...
            if (NormalizedName.IsNullOrEmpty()) throw new ArgumentNullException(nameof(NormalizedName), "名称不能为空！");
